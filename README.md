...
>Проверить попарную разность элементов троек и сравнить элементы между собой.
...
3. **Сравнение всех вариантов модулей разности пар чисел из трёх чисел, сравнение трёх чисел между собой, замена значения `foundProgression` и вывод:**  
   Сравнивает модули разности и три элемента между собой, и если находятся такие равные по модулю разности и не равные между собой элементы, то ищет минимальный и максимальный из трёх элементов,
