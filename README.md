...
graph TD
    ...
    C -- Да --> H{Проверка троек на арифмитическую прогрессию}
    C -- Нет --> D[/Вывод: Данные должны быть в виде натуральных чисел!/]
    {Является ли A, B, C арифмитической прогрессией}
    C -- Да --> H{Является ли A, C, D арифмитической прогрессией}
    C -- Да --> H{Является ли B, C, D арифмитической прогрессией}
    C -- Да --> H{Является ли A, B, D арифмитической прогрессией}
