...
graph TD
    ...
    H -- Да --> M1[Вывод прогрессии из трёх элементов в порядке возрастания]
    H -- Нет --> M2[Ничего]
    I -- Да --> M3[Вывод прогрессии из трёх элементов в порядке возрастания]
    I -- Нет --> M4[Ничего]
    J -- Да --> M5[Вывод прогрессии из трёх элементов в порядке возрастания]
    J -- Нет --> M6[Ничего]
    K -- Да --> M7[Вывод прогрессии из трёх элементов в порядке возрастания]
    K -- Нет --> M8[Ничего]
