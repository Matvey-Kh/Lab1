...
graph TD
    ...
    L ----> H{Является ли A, B, C арифмитической прогрессией}
    L ----> I{Является ли A, C, D арифмитической прогрессией}
    L ----> J{Является ли B, C, D арифмитической прогрессией}
    L ----> K{Является ли A, B, D арифмитической прогрессией}
